...
@section('title', 'Edit Dokumen - ' . $document->nama_dokumen)
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-file-earmark-text"></i> Form Edit Dokumen
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('documents.update', $document) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_dokumen') is-invalid @enderror" 
                               id="nama_dokumen" name="nama_dokumen" value="{{ old('nama_dokumen', $document->nama_dokumen) }}" required>
                        @error('nama_dokumen')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                  id="deskripsi" name="deskripsi" rows="3">{{ old('deskripsi', $document->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input @error('wajib') is-invalid @enderror" 
                                   ...
                                   {{ old('wajib', $document->wajib) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('urutan') is-invalid @enderror" 
                               id="urutan" name="urutan" value="{{ old('urutan', $document->urutan) }}" min="0">
                        @error('urutan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
