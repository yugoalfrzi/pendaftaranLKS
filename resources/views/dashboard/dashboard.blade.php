        ...
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#2563eb,#1d4ed8);">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value">{{ number_format($totalLKS) }}</div>
                </div>
        ...
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#16a34a,#15803d);">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value">{{ number_format($lengkapLKS) }}</div>
                </div>
        ...
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#f59e0b,#d97706);">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value">{{ number_format($menungguLKS) }}</div>
                </div>
        ...
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#7c3aed,#6d28d9);">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value">{{ number_format($diterimaLKS) }}</div>
                </div>
...
{{-- Tabel Semua Pendaftaran LKS --}}
@if($totalLKS > 0)
<div class="card-modern">
    <div class="card-header-custom d-flex justify-content-between align-items-center">
        <span><i class="bi bi-list-check me-2 text-primary"></i>Pendaftaran LKS Terbaru</span>
        <a href="{{ route('lks.index') }}" class="btn btn-sm btn-outline-primary rounded-pill px-3" style="font-size:.78rem">
        ...
        <table class="table mb-0" style="font-size:.83rem;">
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f1f5f9; vertical-align:middle;">
                    ...
                    <td class="px-3 py-2 fw-semibold">{{ $item->nama_lks }}</td>
                    <td class="px-3 py-2 text-muted">{{ $item->kabupaten_kota ?? '-' }}</td>
                    <td class="px-3 py-2">
                        <span class="badge-pill {{ $item->kewenangan_type == 'kabkota' ? 's-proses' : 's-terverifikasi' }}">
                            {{ $item->kewenangan_type == 'kabkota' ? 'Kab/Kota' : 'Provinsi' }}
                        </span>
                    </td>
                    <td class="px-3 py-2">
                        <span class="badge-pill {{ $item->tanda_pendaftaran == 'Baru' ? 's-diterima' : 's-proses' }}">
                    ...
                    <td class="px-3 py-2">
                        <a href="{{ route('lks.show', $item->id) }}" class="btn btn-sm btn-outline-info rounded-pill px-2">
                            <i class="bi bi-eye"></i>
                        </a>
                    </td>
                </tr>
