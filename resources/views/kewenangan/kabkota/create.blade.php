...
@section('title', 'Tambah Data Kewenangan Kabupaten/Kota')
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('kewenangan-kabkota.store') }}" method="POST" id="mainForm">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nomor_tandaDaftar" value="{{ old('nomor_tandaDaftar') }}" required placeholder="Masukkan nomor tanda daftar">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_tandaDaftar" value="{{ old('tanggal_tandaDaftar') }}" required>
