...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="mb-1">Data Kewenangan Kemensos</h2>
                <p class="text-muted mb-0">Kelola data kewenangan LKS tingkat nasional (Kemensos)</p>
            </div>
            <div class="btn-group">
                <a href="{{ route('kewenangan-kemensos.export-excel') }}?search={{ request('search') }}" 
                   class="btn btn-success">
                    <i class="fas fa-file-excel me-2"></i>Export Excel
                </a>
                <a href="{{ route('kewenangan-kemensos.create') }}" class="btn btn-primary">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-table"></i> Data Kewenangan Kemensos
                </h5>
            </div>
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-8">
                        <form method="GET" class="d-flex gap-2">
                            ...
                            @if(request('search'))
                                <a href="{{ route('kewenangan-kemensos.index') }}" 
                            ...
                            <tr class="table-row-hover">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('kewenangan-kemensos.show', $item->id) }}" 
                                           class="btn btn-sm btn-outline-info" title="Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('kewenangan-kemensos.edit', $item->id) }}" 
