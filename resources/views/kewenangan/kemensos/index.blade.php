...
<div class="card-modern mb-4">
    <div class="card-header-custom d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <form method="GET" action="{{ route('kewenangan-kemensos.index') }}" class="d-flex align-items-center gap-2" id="filterKabkotaForm">
            @if(request('search'))
            ...
            @if($filterKabkota)
                <a href="{{ route('kewenangan-kemensos.index', request()->except('filter_kabkota')) }}"
