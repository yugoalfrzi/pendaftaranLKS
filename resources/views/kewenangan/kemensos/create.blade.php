...
@section('title', 'Tambah Data Kewenangan Kemensos')
    ...
    <div class="col-12">
        <div class="card">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h5 class="card-title mb-0">
                            <i class="bi bi-building-gear"></i> Tambah Data Kewenangan Kemensos
                        </h5>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('kewenangan-kemensos.store') }}" method="POST" id="mainForm">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_pusat_nama_provinsi" value="{{ old('tanda_pendaftaran_pusat_nama_provinsi') }}" required placeholder="Masukkan nama provinsi">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_pusat_nomor" value="{{ old('tanda_pendaftaran_pusat_nomor') }}" required placeholder="Masukkan nomor tanda daftar">
