...
@section('title', 'Detail Data Kewenangan Kemensos')
        ...
        <div class="main-card">
            <div class="card-header-custom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1"><i class="bi bi-eye-fill me-2"></i>Detail Data Kewenangan Kemensos</h4>
                        <p class="mb-0 opacity-75">Detail lengkap data Lembaga Kesejahteraan Sosial - Kemensos</p>
                    </div>
                    <div class="d-flex flex-wrap">
                        <a href="{{ route('kewenangan-kemensos.edit', $kewenangan->id) }}" class="btn btn-warning btn-action">
                            <i class="bi bi-pencil-square me-2"></i>Edit Data
                        </a>
                        <a href="{{ route('kewenangan-kemensos.index') }}" class="btn btn-secondary btn-action">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    ...
                                    <div class="info-value">{{ $kewenangan->tanda_pendaftaran_pusat_nama_provinsi }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    ...
                                    <div class="info-value">{{ $kewenangan->tanda_pendaftaran_cabang_nama_provinsi }}</div>
