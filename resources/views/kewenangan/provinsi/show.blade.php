...
@section('title', 'Detail Data Kewenangan Provinsi')
        ...
        <div class="main-card">
            <div class="card-header-custom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1"><i class="bi bi-eye-fill me-2"></i>Detail Data Kewenangan Provinsi</h4>
                        <p class="mb-0 opacity-75">Detail lengkap data Lembaga Kesejahteraan Sosial - Provinsi</p>
                    </div>
                    <div class="d-flex flex-wrap">
                        <a href="{{ route('kewenangan-provinsi.edit', $kewenangan->id) }}" class="btn btn-warning btn-action">
                            <i class="bi bi-pencil-square me-2"></i>Edit Data
                        </a>
                        <a href="{{ route('kewenangan-provinsi.index') }}" class="btn btn-secondary btn-action">
        ...
        <div class="detail-tabs">
            <ul class="nav nav-tabs nav-tabs-custom" id="detailTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="identitas-tab" data-bs-toggle="tab" data-bs-target="#identitas" type="button" role="tab">
                        <i class="bi bi-building me-2"></i>Profil Yasasan & LKS
                    </button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="detailTabsContent">
                ...
                <div class="tab-pane fade" id="dokumen" role="tabpanel">
                    ...
                    <div class="section-card">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">{{ $kewenangan->tanggal_akta ? $kewenangan->tanggal_akta->format('d F Y') : '-' }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-value">{{ $kewenangan->tanggal_pengesahan ? $kewenangan->tanggal_pengesahan->format('d F Y') : '-' }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Tanda Pendaftaran -->
                    <div class="section-card">
                        <h5 class="section-title"><i class="bi bi-file-earmark-check"></i>Tanda Pendaftaran</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    <div class="info-label">Tanda Pendaftaran Pusat</div>
                                    <div class="info-value">{{ $kewenangan->tanda_pendaftaran_pusat_nama_kab_kota ?? '-' }}</div>
                                    <div class="info-value small">No: {{ $kewenangan->tanda_pendaftaran_pusat_nomor ?? '-' }}</div>
                                    <div class="info-value small">Tanggal: {{ $kewenangan->tanda_pendaftaran_pusat_tanggal ? $kewenangan->tanda_pendaftaran_pusat_tanggal->format('d F Y') : '-' }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                    ...
                    <div class="section-card">
                        <h5 class="section-title"><i class="bi bi-file-earmark-text"></i>Rekomendasi & Pendaftaran</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    <div class="info-label">Rekomendasi Dinsos</div>
                                    <div class="info-value">No: {{ $kewenangan->rekom_dinsos_nomor ?? '-' }}</div>
                                    <div class="info-value small">Tanggal: {{ $kewenangan->rekom_dinsos_tanggal ? $kewenangan->rekom_dinsos_tanggal->format('d F Y') : '-' }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    <div class="info-label">Tanda Pendaftaran Provinsi</div>
                                    <div class="info-value">No: {{ $kewenangan->tanda_pendaftaran_provinsi_nomor ?? '-' }}</div>
                                    <div class="info-value small">Tanggal: {{ $kewenangan->tanda_pendaftaran_provinsi_tanggal ? $kewenangan->tanda_pendaftaran_provinsi_tanggal->format('d F Y') : '-' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="pelayanan" role="tabpanel">
                    ...
                    <div class="section-card">
                        ...
                        <div class="stats-container">
                            <div class="stat-card">
                                <div class="stat-value">{{ number_format($kewenangan->jumlah_seluruh_binaan ?? 0) }}</div>
                                <div class="stat-label">Total Binaan</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-value">{{ number_format($kewenangan->jumlah_dalam_panti ?? 0) }}</div>
                                <div class="stat-label">Dalam Panti</div>
                            </div>
                            <div class="stat-card">
                                <div class="stat-value">{{ number_format($kewenangan->jumlah_luar_panti ?? 0) }}</div>
                    ...
                    <div class="ppks-section">
                        ...
                        <div class="ppks-grid">
                            @php
                                $ppksData = [
                                    'Anak Balita Terlantar' => ['dp' => $kewenangan->anak_balita_terlantar_DP ?? 0, 'lp' => $kewenangan->anak_balita_terlantar_LP ?? 0],
                                    'Anak Terlantar' => ['dp' => $kewenangan->anak_terlantar_DP ?? 0, 'lp' => $kewenangan->anak_terlantar_LP ?? 0],
                                    'Anak Berhadapan dengan Hukum' => ['dp' => $kewenangan->anak_yangberhadapan_dengan_hukum_DP ?? 0, 'lp' => $kewenangan->anak_yangberhadapan_dengan_hukum_LP ?? 0],
                                    'Anak Jalanan' => ['dp' => $kewenangan->anak_jalanan_DP ?? 0, 'lp' => $kewenangan->anak_jalanan_LP ?? 0],
                                    'Anak dengan Kedisabilitas' => ['dp' => $kewenangan->anak_dengan_kedisabilitas_DP ?? 0, 'lp' => $kewenangan->anak_dengan_kedisabilitas_LP ?? 0],
                                    'Anak Korban Kekerasan' => ['dp' => $kewenangan->anak_yangmenjadi_tidak_kekerasan_DP ?? 0, 'lp' => $kewenangan->anak_yangmenjadi_tidak_kekerasan_LP ?? 0],
                                    'Anak Perlindungan Khusus' => ['dp' => $kewenangan->anak_yang_memerlukan_perlindungan_khusus_DP ?? 0, 'lp' => $kewenangan->anak_yang_memerlukan_perlindungan_khusus_LP ?? 0],
                                    'Lansia Terlantar' => ['dp' => $kewenangan->lanjut_usia_terlantar_DP ?? 0, 'lp' => $kewenangan->lanjut_usia_terlantar_LP ?? 0],
                                    'Disabilitas Fisik' => ['dp' => $kewenangan->disabilitas_fisik_DP ?? 0, 'lp' => $kewenangan->disabilitas_fisik_LP ?? 0],
                                    'Disabilitas Intelektual' => ['dp' => $kewenangan->disabilitas_intelektual_DP ?? 0, 'lp' => $kewenangan->disabilitas_intelektual_LP ?? 0],
                                    'Disabilitas Mental' => ['dp' => $kewenangan->disabilitas_mental_DP ?? 0, 'lp' => $kewenangan->disabilitas_mental_LP ?? 0],
                                    'Disabilitas Sensorik' => ['dp' => $kewenangan->disabilitas_sensorik_DP ?? 0, 'lp' => $kewenangan->disabilitas_sensorik_LP ?? 0],
                                    'Tuna Susila' => ['dp' => $kewenangan->tuna_susila_DP ?? 0, 'lp' => $kewenangan->tuna_susila_LP ?? 0],
                                    'Gelandangan' => ['dp' => $kewenangan->gelandangan_DP ?? 0, 'lp' => $kewenangan->gelandangan_LP ?? 0],
                                    'Pengemis' => ['dp' => $kewenangan->pengemis_DP ?? 0, 'lp' => $kewenangan->pengemis_LP ?? 0],
                                    'Pemulung' => ['dp' => $kewenangan->pemulung_DP ?? 0, 'lp' => $kewenangan->pemulung_LP ?? 0],
                                    'Kelompok Minoritas' => ['dp' => $kewenangan->kelompok_minoritas_DP ?? 0, 'lp' => $kewenangan->kelompok_minoritas_LP ?? 0],
                                    'BWBLP' => ['dp' => $kewenangan->BWBLP_DP ?? 0, 'lp' => $kewenangan->BWBLP_LP ?? 0],
                                    'ODHA' => ['dp' => $kewenangan->orang_dengan_hiv_aids_DP ?? 0, 'lp' => $kewenangan->orang_dengan_hiv_aids_LP ?? 0],
                                    'Korban Napza' => ['dp' => $kewenangan->penyalahgunaan_Napza_DP ?? 0, 'lp' => $kewenangan->penyalahgunaan_Napza_LP ?? 0],
                                    'Korban Trafficking' => ['dp' => $kewenangan->korban_Trafficking_DP ?? 0, 'lp' => $kewenangan->korban_Trafficking_LP ?? 0],
                                    'Korban Kekerasan' => ['dp' => $kewenangan->korban_tindak_kekerasan_DP ?? 0, 'lp' => $kewenangan->korban_tindak_kekerasan_LP ?? 0],
                                    'PMBS' => ['dp' => $kewenangan->PMBS_DP ?? 0, 'lp' => $kewenangan->PMBS_LP ?? 0],
                                    'Korban Bencana Alam' => ['dp' => $kewenangan->korban_bencana_alam_DP ?? 0, 'lp' => $kewenangan->korban_bencana_alam_LP ?? 0],
                                    'Korban Bencana Sosial' => ['dp' => $kewenangan->korban_bencana_sosial_DP ?? 0, 'lp' => $kewenangan->korban_bencana_sosial_LP ?? 0],
                                    'Perempuan Rawan Sosial Ekonomi' => ['dp' => $kewenangan->perempuan_rawan_sosial_ekonomi_DP ?? 0, 'lp' => $kewenangan->perempuan_rawan_sosial_ekonomi_LP ?? 0],
                                    'Fakir Miskin' => ['dp' => $kewenangan->fakir_miskin_DP ?? 0, 'lp' => $kewenangan->fakir_miskin_LP ?? 0],
                                    'Keluarga Bermasalah' => ['dp' => $kewenangan->keluarga_bermasalah_sosial_psikologis_DP ?? 0, 'lp' => $kewenangan->keluarga_bermasalah_sosial_psikologis_LP ?? 0],
                                    'Komunitas Adat Terpencil' => ['dp' => $kewenangan->komunitas_adat_terpencil_DP ?? 0, 'lp' => $kewenangan->komunitas_adat_terpencil_LP ?? 0],
                                ];
                            @endphp
