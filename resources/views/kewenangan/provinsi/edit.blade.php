...
@section('title', 'Edit Data Kewenangan Provinsi')
        ...
        <div class="card">
            <div class="card-header province-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-building-check"></i> Edit Data Kewenangan Provinsi
                </h5>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('kewenangan-provinsi.update', $kewenangan->id) }}" method="POST" id="mainForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kabupaten_kota" value="{{ old('kabupaten_kota', $kewenangan->kabupaten_kota) }}" required placeholder="Masukkan kabupaten/kota">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="kabupaten_kota_lks" value="{{ old('kabupaten_kota_lks', $kewenangan->kabupaten_kota_lks) }}" required placeholder="Masukkan kabupaten/kota LKS">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_akta" value="{{ old('tanggal_akta', $kewenangan->tanggal_akta) }}" required>
                                    @error('tanggal_akta')
                                        <div class="text-danger mt-1"><small><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</small></div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_pengesahan" value="{{ old('tanggal_pengesahan', $kewenangan->tanggal_pengesahan) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_pusat_nama_kab_kota" value="{{ old('tanda_pendaftaran_pusat_nama_kab_kota', $kewenangan->tanda_pendaftaran_pusat_nama_kab_kota) }}" required placeholder="Masukkan nama kabupaten/kota pusat">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_pusat_nomor" value="{{ old('tanda_pendaftaran_pusat_nomor', $kewenangan->tanda_pendaftaran_pusat_nomor) }}" required placeholder="Masukkan nomor tanda daftar pusat">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanda_pendaftaran_pusat_tanggal" value="{{ old('tanda_pendaftaran_pusat_tanggal', $kewenangan->tanda_pendaftaran_pusat_tanggal) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_cabang_nama_kab_kota" value="{{ old('tanda_pendaftaran_cabang_nama_kab_kota', $kewenangan->tanda_pendaftaran_cabang_nama_kab_kota) }}" required placeholder="Masukkan nama kabupaten/kota cabang">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_cabang_nomor" value="{{ old('tanda_pendaftaran_cabang_nomor', $kewenangan->tanda_pendaftaran_cabang_nomor) }}" required placeholder="Masukkan nomor tanda daftar cabang">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanda_pendaftaran_cabang_tanggal" value="{{ old('tanda_pendaftaran_cabang_tanggal', $kewenangan->tanda_pendaftaran_cabang_tanggal) }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="rekom_dinsos_tanggal" value="{{ old('rekom_dinsos_tanggal', $kewenangan->rekom_dinsos_tanggal) }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanda_pendaftaran_provinsi_tanggal" value="{{ old('tanda_pendaftaran_provinsi_tanggal', $kewenangan->tanda_pendaftaran_provinsi_tanggal) }}" required>
