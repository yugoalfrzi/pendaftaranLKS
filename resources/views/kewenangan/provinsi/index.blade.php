...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="mb-1">Data Kewenangan Provinsi</h2>
                <p class="text-muted mb-0">Kelola data kewenangan LKS tingkat provinsi</p>
            </div>
            <div class="btn-group">
                <a href="{{ route('kewenangan-provinsi.export-excel') }}?search={{ request('search') }}" 
                   class="btn btn-success">
                    <i class="fas fa-file-excel me-2"></i>Export Excel
                </a>
                <a href="{{ route('kewenangan-provinsi.create') }}" class="btn btn-primary">
                    ...
                    <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="text-muted">
                                        ...
                                        <h5>Tidak ada data jenis pelayanan</h5>
                                        <p>Data jenis pelayanan belum tersedia</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
                        ...
                        <tfoot class="table-light">
                            <tr>
                                ...
                                <th class="text-center">{{ number_format($totalLKS, 0, ',', '.') }}</th>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="bi bi-table"></i> Data Kewenangan Provinsi
                </h5>
            </div>
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-8">
                        <form method="GET" class="d-flex gap-2">
                            ...
                            @if(request('search'))
                                <a href="{{ route('kewenangan-provinsi.index') }}" 
                            ...
                            <tr class="table-row-hover">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('kewenangan-provinsi.show', $item->id) }}" 
                                           class="btn btn-sm btn-outline-info" title="Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('kewenangan-provinsi.edit', $item->id) }}" 
