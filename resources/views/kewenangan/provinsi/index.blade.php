...
@section('title', 'Data Kewenangan Provinsi')
...
@auth
    ...
    <ul class="nav nav-pills nav-pills-custom" id="levelTabs">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('kewenangan-provinsi.index') }}">
...
<div class="card-modern mb-4">
    <div class="card-header-custom d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <form method="GET" action="{{ route('kewenangan-provinsi.index') }}" class="d-flex align-items-center gap-2" id="filterKabkotaForm">
            @if(request('search'))
            ...
            @if($filterKabkota)
                <a href="{{ route('kewenangan-provinsi.index', request()->except('filter_kabkota')) }}"
    ...
    <div class="card-body p-4">
        ...
        <div class="filter-card p-0 mb-4 border-0 bg-transparent">
            <form method="GET" class="row g-3">
                ...
                @if(request('search'))
                <div class="col-md-2">
                    <a href="{{ route('kewenangan-provinsi.index') }}" class="btn btn-outline-secondary rounded-pill w-100">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <a href="{{ route('kewenangan-provinsi.show', $item->id) }}" class="btn btn-sm btn-outline-info rounded-pill me-1" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                @auth
                                    @if(Auth::user()->hasRole('super_admin'))
                                        <a href="{{ route('kewenangan-provinsi.edit', $item->id) }}" class="btn btn-sm btn-outline-warning rounded-pill me-1" title="Edit">
