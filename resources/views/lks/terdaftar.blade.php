...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center justify-content-between py-3">
                <div>
                    <h4 class="mb-0">{{ $stats['kabkota'] + $stats['provinsi'] }}</h4>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center justify-content-between py-3">
                <div>
                    <h4 class="mb-0">{{ $stats['kabkota'] }}</h4>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body d-flex align-items-center justify-content-between py-3">
                <div>
                    <h4 class="mb-0">{{ $stats['provinsi'] }}</h4>
    ...
    <div class="card-body py-3">
        <form method="GET" action="{{ route('lks.terdaftar') }}">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="{{ route('lks.terdaftar') }}" class="btn btn-outline-secondary btn-sm w-100">
            ...
            <table class="table table-hover table-sm align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge {{ $item->tanda_pendaftaran == 'Baru' ? 'bg-success' : 'bg-info' }}">
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('admin.verification.preview-sertifikat-kabkota', $item->id) }}"
                                   target="_blank" class="btn btn-outline-info" title="Preview">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="{{ route('admin.verification.download-sertifikat-kabkota', $item->id) }}"
                        ...
                        <td>
                            <a href="{{ route('lks.show', $item->id) }}" class="btn btn-sm btn-outline-primary" title="Lihat Detail">
                                <i class="bi bi-eye"></i>
                            </a>
                        </td>
                    </tr>
            ...
            <table class="table table-hover table-sm align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('superadmin.preview-surat', $item->id) }}"
                                   target="_blank" class="btn btn-outline-info" title="Preview">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="{{ route('superadmin.download-surat', $item->id) }}"
                                   class="btn btn-outline-success" title="Download">
                                    <i class="bi bi-download"></i> Download
                                </a>
                            </div>
