...
return new class extends Migration
{
    ...
    {
        Schema::create('kewenangan_kemensos', function (Blueprint $table) {
            $table->id();
            ...
            //pusat
            $table->string('tanda_pendaftaran_pusat_nama_provinsi');
            $table->string('tanda_pendaftaran_pusat_nomor');
            $table->date('tanda_pendaftaran_pusat_tanggal');
            //cabang
            $table->string('tanda_pendaftaran_cabang_nama_provinsi');
            $table->string('tanda_pendaftaran_cabang_nomor');
            $table->date('tanda_pendaftaran_cabang_tanggal');
            //rekomendasi dinsos provinsi jawa barat
            $table->string('rekom_dinsos_nomor');
            $table->date('rekom_dinsos_tanggal');
            //tanda pendaftaran kemensos
            $table->string('tanda_pendaftaran_provinsi_nomor');
            $table->date('tanda_pendaftaran_provinsi_tanggal');
    ...
    {
        Schema::dropIfExists('kewenangan_kemensos');
    }
};
