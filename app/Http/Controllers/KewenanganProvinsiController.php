...
class KewenanganProvinsiController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (auth()->check() && auth()->user()->hasRole('user')) {
            return redirect()->route('kewenangan-provinsi.create');
        }
        ...
        $query = KewenanganProvinsi::query();
        ...
        return view('kewenangan.provinsi.index', compact('kewenangan', 'statistics', 'filterKabkota', 'isAdmin'));
    }

    public function create()
    {
        return view('kewenangan.provinsi.create');
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'tanda_pendaftaran_pusat_nama_kab_kota' => 'required|string|max:255',
            'tanda_pendaftaran_pusat_nomor' => 'required|string|max:255',
            'tanda_pendaftaran_pusat_tanggal' => 'required|date',
            'tanda_pendaftaran_cabang_nama_kab_kota' => 'required|string|max:255',
            'tanda_pendaftaran_cabang_nomor' => 'required|string|max:255',
            'tanda_pendaftaran_cabang_tanggal' => 'required|date',
            'rekom_dinsos_nomor' => 'required|string|max:255',
            'rekom_dinsos_tanggal' => 'required|date',
            'tanda_pendaftaran_provinsi_nomor' => 'required|string|max:255',
            'tanda_pendaftaran_provinsi_tanggal' => 'required|date',
        ...
        if (auth()->user()->hasRole('user')) {
            return redirect()->route('kewenangan-provinsi.create')
                             ->with('success', 'Data Kewenangan Provinsi berhasil ditambahkan.');
        }

        return redirect()->route('kewenangan-provinsi.index')
                         ->with('success', 'Data Kewenangan Provinsi berhasil ditambahkan.');
    }

    public function show(KewenanganProvinsi $kewenangan)
    {
        return view('kewenangan.provinsi.show', compact('kewenangan'));
    }

    public function edit(KewenanganProvinsi $kewenangan)
    {
        return view('kewenangan.provinsi.edit', compact('kewenangan'));
    }

    public function update(Request $request, KewenanganProvinsi $kewenangan)
    {
        $validated = $request->validate([
            'Nama_Lembaga_Yayasan' => 'required|string',
            'status' => 'required|in:pusat,cabang',
    ...
    public function destroy(KewenanganProvinsi $kewenangan)
    {
        $kewenangan->delete();
        ...
        if (auth()->user()->hasRole('user')) {
            return redirect()->route('kewenangan-provinsi.create')
                             ->with('success', 'Data Kewenangan Provinsi berhasil dihapus.');
        }
    ...
    {
        $baseQuery = KewenanganProvinsi::query();
        if ($filterKabkota) {
        ...
        $statsByKabupaten = KewenanganProvinsi::select(
            'kabupaten_kota',
            DB::raw('SUM(jumlah_dalam_panti) as total_dalam_panti'),
            DB::raw('SUM(jumlah_luar_panti) as total_luar_panti'),
            DB::raw('COUNT(*) as total_lks')
    ...
    private function getStatsByJenisPelayanan($filterKabkota = null)
    {
        ...
        $allDataQuery = KewenanganProvinsi::whereNotNull('jenis_pelayanan_PPKS')
    ...
    /**
     * Export Excel untuk kewenangan provinsi
     */
    public function exportExcel(Request $request)
    {
        ...
        $filename = 'kewenangan_provinsi_' . date('Y_m_d_His') . '.xls';
    ...
    /**
     * Generate HTML table untuk Excel kewenangan provinsi
     */
    private function generateExcelTable($kewenangan)
    {
        ...
        <head>
            ...
            <title>Data Kewenangan Provinsi</title>
            <style>
        ...
        <body>
            <div class="header">
                <h2>DATA KEWENANGAN PROVINSI</h2>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th width="8%">Anak yang berhadapan dengan hukum</th>
                        <th width="8%">Anak jalanan</th>
                        <th width="8%">Anak dengan kedisabilitasan</th>
                        <th width="8%">Anak menjadi korban tindak kekerasan</th>
                        <th width="8%">Anak yang memerlukan perlindungan khusus</th>
                        ...
                        <th width="8%">BWBLP</th>
                        <th width="8%">Orang dengan HIV/AIDS</th>
                        <th width="8%">Korban penyalahgunaan NAPZA</th>
