<?php $__env->startSection('title', 'Peraturan Perundang-Undangan LKS'); ?>
<?php $__env->startSection('page-title', 'Regulasi'); ?>
        ...
        <div class="stat-card p-3">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value"><?php echo e(count($regulations)); ?></div>
                </div>
        ...
        <div class="stat-card p-3">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value"><?php echo e(count(array_unique(array_column($regulations, 'category')))); ?></div>
                </div>
        ...
        <div class="stat-card p-3">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value"><?php echo e(number_format(array_sum(array_column($regulations, 'download_count')))); ?></div>
                </div>
        ...
        <div class="stat-card p-3">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="stat-value"><?php echo e(!empty($years) ? max($years) : date('Y')); ?></div>
                </div>
                ...
                <div class="regulation-card p-3">
                    <div class="d-flex gap-3">
                        <div class="regulation-icon flex-0">
                            <i class="bi <?php echo e($regulation['icon'] ?? 'bi-file-earmark-text'); ?>"></i>
                        </div>
                        <div class="flex-1">
                            <h6 class="fw-bold mb-1"><?php echo e($regulation['title']); ?></h6>
                            <p class="small text-secondary mb-2"><?php echo e($regulation['description']); ?></p>
                            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                                <div class="d-flex gap-2 align-items-center">
                                    ...
                                    ?>
                                    <span class="badge-category <?php echo e($badgeClass); ?>"><?php echo e($cat); ?></span>
                                    <small class="text-muted"><i class="bi bi-calendar3"></i> <?php echo e($regulation['year']); ?></small>
                                </div>
                                <div class="d-flex gap-2">
                                    <small class="text-muted"><i class="bi bi-download"></i> <?php echo e(number_format($regulation['download_count'])); ?></small>
                                    <small class="text-muted"><?php echo e($regulation['file_size']); ?></small>
                                </div>
                            </div>
                            <div class="mt-3 d-flex gap-2">
                                <a href="<?php echo e(route('announcements.download', ['type' => 'regulasi', 'filename' => $regulation['file_name']])); ?>" 
                                   class="btn btn-sm btn-primary rounded-pill px-3 download-btn"
                                   data-filename="<?php echo e($regulation['file_name']); ?>"
                                   data-title="<?php echo e($regulation['title']); ?>">
                                    <i class="bi bi-download"></i> Download
                                </a>
                                <?php if(pathinfo($regulation['file_name'], PATHINFO_EXTENSION) === 'pdf'): ?>
                                <a href="<?php echo e(route('announcements.preview', ['type' => 'regulasi', 'filename' => $regulation['file_name']])); ?>" 
                                   target="_blank" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <?php endif; ?>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(Auth::user()->hasRole('admin') && isset($regulation['id'])): ?>
                                    <form action="<?php echo e(route('announcements.destroy', ['id' => $regulation['id']])); ?>" method="POST" onsubmit="return confirm('Hapus dokumen ini?');" class="d-inline">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="card-modern">
                ...
                <div class="card-body p-4">
                    <div class="row g-3 justify-content-center">
                        <div class="col-md-4">
                            <a href="<?php echo e(route('announcements.create')); ?>" class="btn btn-primary w-100 py-2 rounded-pill">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pendaftaranLKS\resources\views/announcements/regulasi.blade.php ENDPATH**/ ?>