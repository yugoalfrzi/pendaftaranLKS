<?php $__env->startSection('title', 'Pendaftaran LKS'); ?>
<?php $__env->startSection('page-title', 'Pendaftaran LKS'); ?>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('lks.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    <input type="radio" class="btn-check" name="kewenangan_type" id="kew_kabkota" value="kabkota" <?php echo e(old('kewenangan_type', 'kabkota') == 'kabkota' ? 'checked' : ''); ?> required>
                                ...
                                <div class="col-md-6">
                                    <input type="radio" class="btn-check" name="kewenangan_type" id="kew_provinsi" value="provinsi" <?php echo e(old('kewenangan_type') == 'provinsi' ? 'checked' : ''); ?>>
                            ...
                            <?php $__errorArgs = ['kewenangan_type'];
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   id="nama_lks" name="nama_lks" value="<?php echo e(old('nama_lks')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   id="nama_ketua_lks" name="nama_ketua_lks" value="<?php echo e(old('nama_ketua_lks')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      id="alamat_lks" name="alamat_lks" rows="3" required><?php echo e(old('alamat_lks')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="hidden" id="jenis_pelayanan" name="jenis_pelayanan" value="<?php echo e(old('jenis_pelayanan')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('jumlah_binaan_dalam_panti')); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('jumlah_binaan_luar_panti')); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   id="nomor_kontak" name="nomor_kontak" value="<?php echo e(old('nomor_kontak')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="Kabupaten Bogor" <?php echo e(old('lokasi_lks') == 'Kabupaten Bogor' ? 'selected' : ''); ?>>Kabupaten Bogor</option>
                                <option value="Kabupaten Sukabumi" <?php echo e(old('lokasi_lks') == 'Kabupaten Sukabumi' ? 'selected' : ''); ?>>Kabupaten Sukabumi</option>
                                <option value="Kabupaten Cianjur" <?php echo e(old('lokasi_lks') == 'Kabupaten Cianjur' ? 'selected' : ''); ?>>Kabupaten Cianjur</option>
                                <option value="Kabupaten Bandung" <?php echo e(old('lokasi_lks') == 'Kabupaten Bandung' ? 'selected' : ''); ?>>Kabupaten Bandung</option>
                                <option value="Kabupaten Garut" <?php echo e(old('lokasi_lks') == 'Kabupaten Garut' ? 'selected' : ''); ?>>Kabupaten Garut</option>
                                <option value="Kabupaten Tasikmalaya" <?php echo e(old('lokasi_lks') == 'Kabupaten Tasikmalaya' ? 'selected' : ''); ?>>Kabupaten Tasikmalaya</option>
                                <option value="Kabupaten Ciamis" <?php echo e(old('lokasi_lks') == 'Kabupaten Ciamis' ? 'selected' : ''); ?>>Kabupaten Ciamis</option>
                                <option value="Kabupaten Kuningan" <?php echo e(old('lokasi_lks') == 'Kabupaten Kuningan' ? 'selected' : ''); ?>>Kabupaten Kuningan</option>
                                <option value="Kabupaten Cirebon" <?php echo e(old('lokasi_lks') == 'Kabupaten Cirebon' ? 'selected' : ''); ?>>Kabupaten Cirebon</option>
                                <option value="Kabupaten Majalengka" <?php echo e(old('lokasi_lks') == 'Kabupaten Majalengka' ? 'selected' : ''); ?>>Kabupaten Majalengka</option>
                                <option value="Kabupaten Sumedang" <?php echo e(old('lokasi_lks') == 'Kabupaten Sumedang' ? 'selected' : ''); ?>>Kabupaten Sumedang</option>
                                <option value="Kabupaten Indramayu" <?php echo e(old('lokasi_lks') == 'Kabupaten Indramayu' ? 'selected' : ''); ?>>Kabupaten Indramayu</option>
                                <option value="Kabupaten Subang" <?php echo e(old('lokasi_lks') == 'Kabupaten Subang' ? 'selected' : ''); ?>>Kabupaten Subang</option>
                                <option value="Kabupaten Purwakarta" <?php echo e(old('lokasi_lks') == 'Kabupaten Purwakarta' ? 'selected' : ''); ?>>Kabupaten Purwakarta</option>
                                <option value="Kabupaten Karawang" <?php echo e(old('lokasi_lks') == 'Kabupaten Karawang' ? 'selected' : ''); ?>>Kabupaten Karawang</option>
                                <option value="Kabupaten Bekasi" <?php echo e(old('lokasi_lks') == 'Kabupaten Bekasi' ? 'selected' : ''); ?>>Kabupaten Bekasi</option>
                                <option value="Kabupaten Bandung Barat" <?php echo e(old('lokasi_lks') == 'Kabupaten Bandung Barat' ? 'selected' : ''); ?>>Kabupaten Bandung Barat</option>
                                <option value="Kabupaten Pangandaran" <?php echo e(old('lokasi_lks') == 'Kabupaten Pangandaran' ? 'selected' : ''); ?>>Kabupaten Pangandaran</option>
                                <option value="Kota Bogor" <?php echo e(old('lokasi_lks') == 'Kota Bogor' ? 'selected' : ''); ?>>Kota Bogor</option>
                                <option value="Kota Sukabumi" <?php echo e(old('lokasi_lks') == 'Kota Sukabumi' ? 'selected' : ''); ?>>Kota Sukabumi</option>
                                <option value="Kota Bandung" <?php echo e(old('lokasi_lks') == 'Kota Bandung' ? 'selected' : ''); ?>>Kota Bandung</option>
                                <option value="Kota Cirebon" <?php echo e(old('lokasi_lks') == 'Kota Cirebon' ? 'selected' : ''); ?>>Kota Cirebon</option>
                                <option value="Kota Bekasi" <?php echo e(old('lokasi_lks') == 'Kota Bekasi' ? 'selected' : ''); ?>>Kota Bekasi</option>
                                <option value="Kota Depok" <?php echo e(old('lokasi_lks') == 'Kota Depok' ? 'selected' : ''); ?>>Kota Depok</option>
                                <option value="Kota Cimahi" <?php echo e(old('lokasi_lks') == 'Kota Cimahi' ? 'selected' : ''); ?>>Kota Cimahi</option>
                                <option value="Kota Tasikmalaya" <?php echo e(old('lokasi_lks') == 'Kota Tasikmalaya' ? 'selected' : ''); ?>>Kota Tasikmalaya</option>
                                <option value="Kota Banjar" <?php echo e(old('lokasi_lks') == 'Kota Banjar' ? 'selected' : ''); ?>>Kota Banjar</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="pusat_cabang_section" style="<?php echo e(old('kewenangan_type', 'kabkota') === 'kabkota' ? 'display:none;' : ''); ?>">
                        <div class="col-md-6 mb-3">
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="">Pilih Kabupaten/Kota</option>
                                <option value="Kabupaten Bogor" <?php echo e(old('pusat_lks') == 'Kabupaten Bogor' ? 'selected' : ''); ?>>Kabupaten Bogor</option>
                                <option value="Kabupaten Sukabumi" <?php echo e(old('pusat_lks') == 'Kabupaten Sukabumi' ? 'selected' : ''); ?>>Kabupaten Sukabumi</option>
                                <option value="Kabupaten Cianjur" <?php echo e(old('pusat_lks') == 'Kabupaten Cianjur' ? 'selected' : ''); ?>>Kabupaten Cianjur</option>
                                <option value="Kabupaten Bandung" <?php echo e(old('pusat_lks') == 'Kabupaten Bandung' ? 'selected' : ''); ?>>Kabupaten Bandung</option>
                                <option value="Kabupaten Garut" <?php echo e(old('pusat_lks') == 'Kabupaten Garut' ? 'selected' : ''); ?>>Kabupaten Garut</option>
                                <option value="Kabupaten Tasikmalaya" <?php echo e(old('pusat_lks') == 'Kabupaten Tasikmalaya' ? 'selected' : ''); ?>>Kabupaten Tasikmalaya</option>
                                <option value="Kabupaten Ciamis" <?php echo e(old('pusat_lks') == 'Kabupaten Ciamis' ? 'selected' : ''); ?>>Kabupaten Ciamis</option>
                                <option value="Kabupaten Kuningan" <?php echo e(old('pusat_lks') == 'Kabupaten Kuningan' ? 'selected' : ''); ?>>Kabupaten Kuningan</option>
                                <option value="Kabupaten Cirebon" <?php echo e(old('pusat_lks') == 'Kabupaten Cirebon' ? 'selected' : ''); ?>>Kabupaten Cirebon</option>
                                <option value="Kabupaten Majalengka" <?php echo e(old('pusat_lks') == 'Kabupaten Majalengka' ? 'selected' : ''); ?>>Kabupaten Majalengka</option>
                                <option value="Kabupaten Sumedang" <?php echo e(old('pusat_lks') == 'Kabupaten Sumedang' ? 'selected' : ''); ?>>Kabupaten Sumedang</option>
                                <option value="Kabupaten Indramayu" <?php echo e(old('pusat_lks') == 'Kabupaten Indramayu' ? 'selected' : ''); ?>>Kabupaten Indramayu</option>
                                <option value="Kabupaten Subang" <?php echo e(old('pusat_lks') == 'Kabupaten Subang' ? 'selected' : ''); ?>>Kabupaten Subang</option>
                                <option value="Kabupaten Purwakarta" <?php echo e(old('pusat_lks') == 'Kabupaten Purwakarta' ? 'selected' : ''); ?>>Kabupaten Purwakarta</option>
                                <option value="Kabupaten Karawang" <?php echo e(old('pusat_lks') == 'Kabupaten Karawang' ? 'selected' : ''); ?>>Kabupaten Karawang</option>
                                <option value="Kabupaten Bekasi" <?php echo e(old('pusat_lks') == 'Kabupaten Bekasi' ? 'selected' : ''); ?>>Kabupaten Bekasi</option>
                                <option value="Kabupaten Bandung Barat" <?php echo e(old('pusat_lks') == 'Kabupaten Bandung Barat' ? 'selected' : ''); ?>>Kabupaten Bandung Barat</option>
                                <option value="Kabupaten Pangandaran" <?php echo e(old('pusat_lks') == 'Kabupaten Pangandaran' ? 'selected' : ''); ?>>Kabupaten Pangandaran</option>
                                <option value="Kota Bogor" <?php echo e(old('pusat_lks') == 'Kota Bogor' ? 'selected' : ''); ?>>Kota Bogor</option>
                                <option value="Kota Sukabumi" <?php echo e(old('pusat_lks') == 'Kota Sukabumi' ? 'selected' : ''); ?>>Kota Sukabumi</option>
                                <option value="Kota Bandung" <?php echo e(old('pusat_lks') == 'Kota Bandung' ? 'selected' : ''); ?>>Kota Bandung</option>
                                <option value="Kota Cirebon" <?php echo e(old('pusat_lks') == 'Kota Cirebon' ? 'selected' : ''); ?>>Kota Cirebon</option>
                                <option value="Kota Bekasi" <?php echo e(old('pusat_lks') == 'Kota Bekasi' ? 'selected' : ''); ?>>Kota Bekasi</option>
                                <option value="Kota Depok" <?php echo e(old('pusat_lks') == 'Kota Depok' ? 'selected' : ''); ?>>Kota Depok</option>
                                <option value="Kota Cimahi" <?php echo e(old('pusat_lks') == 'Kota Cimahi' ? 'selected' : ''); ?>>Kota Cimahi</option>
                                <option value="Kota Tasikmalaya" <?php echo e(old('pusat_lks') == 'Kota Tasikmalaya' ? 'selected' : ''); ?>>Kota Tasikmalaya</option>
                                <option value="Kota Banjar" <?php echo e(old('pusat_lks') == 'Kota Banjar' ? 'selected' : ''); ?>>Kota Banjar</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="hidden" name="cabang_lks" id="cabang_lks_hidden" value="<?php echo e(old('cabang_lks')); ?>">
                            ...
                            <div class="checkbox-container" id="checkboxList">
                                ...
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Bogor" id="bogorKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Bogor') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bogorKab">Kabupaten Bogor</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Sukabumi" id="sukabumiKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Sukabumi') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="sukabumiKab">Kabupaten Sukabumi</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Cianjur" id="cianjurKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Cianjur') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="cianjurKab">Kabupaten Cianjur</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Bandung" id="bandungKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Bandung') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bandungKab">Kabupaten Bandung</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Garut" id="garutKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Garut') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="garutKab">Kabupaten Garut</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Tasikmalaya" id="tasikmalayaKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Tasikmalaya') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="tasikmalayaKab">Kabupaten Tasikmalaya</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Ciamis" id="ciamisKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Ciamis') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="ciamisKab">Kabupaten Ciamis</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Kuningan" id="kuninganKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Kuningan') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="kuninganKab">Kabupaten Kuningan</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Cirebon" id="cirebonKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Cirebon') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="cirebonKab">Kabupaten Cirebon</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Majalengka" id="majalengkaKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Majalengka') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="majalengkaKab">Kabupaten Majalengka</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Sumedang" id="sumedangKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Sumedang') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="sumedangKab">Kabupaten Sumedang</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Indramayu" id="indramayuKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Indramayu') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="indramayuKab">Kabupaten Indramayu</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Subang" id="subangKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Subang') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="subangKab">Kabupaten Subang</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Purwakarta" id="purwakartaKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Purwakarta') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="purwakartaKab">Kabupaten Purwakarta</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Karawang" id="karawangKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Karawang') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="karawangKab">Kabupaten Karawang</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Bekasi" id="bekasiKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Bekasi') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bekasiKab">Kabupaten Bekasi</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Bandung Barat" id="bandungBaratKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Bandung Barat') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bandungBaratKab">Kabupaten Bandung Barat</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kabupaten Pangandaran" id="pangandaranKab" <?php echo e(str_contains(old('cabang_lks'), 'Kabupaten Pangandaran') ? 'checked' : ''); ?>>
                                ...
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Bogor" id="bogorKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Bogor') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bogorKota">Kota Bogor</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Sukabumi" id="sukabumiKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Sukabumi') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="sukabumiKota">Kota Sukabumi</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Bandung" id="bandungKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Bandung') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bandungKota">Kota Bandung</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Cirebon" id="cirebonKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Cirebon') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="cirebonKota">Kota Cirebon</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Bekasi" id="bekasiKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Bekasi') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="bekasiKota">Kota Bekasi</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Depok" id="depokKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Depok') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="depokKota">Kota Depok</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Cimahi" id="cimahiKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Cimahi') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="cimahiKota">Kota Cimahi</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Tasikmalaya" id="tasikmalayaKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Tasikmalaya') ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="tasikmalayaKota">Kota Tasikmalaya</label>
                                    </div>
                                </div>
                                <div class="checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input cabang-checkbox" type="checkbox" value="Kota Banjar" id="banjarKota" <?php echo e(str_contains(old('cabang_lks'), 'Kota Banjar') ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('tanggal_masuk_dokumen')); ?>" required>
                                        ...
                                        <tr class="<?php echo e($rowClass); ?>" data-doc-urutan="<?php echo e($document->urutan); ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if($document->deskripsi): ?>
                                                    <br><small class="text-muted"><?php echo e($document->deskripsi); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="status-alert" id="status_alert_<?php echo e($index); ?>">
                                                    <div class="alert alert-warning py-2 mb-0">
                                                        <i class="bi bi-exclamation-triangle"></i> Belum ada
                                                    </div>
                                                </div>
                                                <input type="hidden" name="documents[<?php echo e($index); ?>][document_id]" value="<?php echo e($document->id); ?>">
                                                <input type="hidden" name="documents[<?php echo e($index); ?>][kelengkapan]" id="kelengkapan_<?php echo e($index); ?>" value="Tidak Ada">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control form-control-sm mb-2" 
                                                       name="documents[<?php echo e($index); ?>][keterangan]" 
                                                       value="<?php echo e(old("documents.{$index}.keterangan")); ?>" 
                                                       placeholder="Keterangan (opsional)">
                                                <div id="file_list_<?php echo e($index); ?>" class="file-list-container small">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pendaftaranLKS\resources\views/lks/create.blade.php ENDPATH**/ ?>