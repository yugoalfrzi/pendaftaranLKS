...
<style>
    ...
    .stat-label { font-size: .68rem; font-weight: 600; text-transform: uppercase; letter-spacing: .04em; }
    .card-modern {
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    <div>
        ...
        <p class="text-muted small mb-0">Selamat datang, <strong><?php echo e(auth()->user()->name); ?></strong> &mdash; Sistem Pendaftaran LKS Jawa Barat</p>
    </div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('superadmin.index')); ?>" class="btn btn-primary rounded-pill px-4 btn-sm">
            <i class="bi bi-shield-check me-1"></i> Panel Verifikasi
        </a>
        <a href="<?php echo e(route('superadmin.pending-users')); ?>" class="btn btn-outline-warning rounded-pill px-4 btn-sm">
            ...
            <div class="card-body p-3">
                <?php if($kewenanganChartData['total'] > 0): ?>
                    ...
                    <div class="row mt-3 text-center g-0">
                        <div class="col-4">
                            <div class="fw-bold text-primary small"><?php echo e(number_format($kewenanganKabkota)); ?></div>
                            <div class="text-muted" style="font-size:.7rem">Kab/Kota</div>
                            <div class="text-muted" style="font-size:.68rem"><?php echo e($kewenanganChartData['percentages'][0]); ?>%</div>
                        </div>
                        <div class="col-4">
                            <div class="fw-bold text-success small"><?php echo e(number_format($kewenanganProvinsi)); ?></div>
                            <div class="text-muted" style="font-size:.7rem">Provinsi</div>
                            <div class="text-muted" style="font-size:.68rem"><?php echo e($kewenanganChartData['percentages'][1]); ?>%</div>
                        </div>
                        <div class="col-4">
                            <div class="fw-bold text-info small"><?php echo e(number_format($kewenanganKemensos)); ?></div>
                            <div class="text-muted" style="font-size:.7rem">Kemensos</div>
                            <div class="text-muted" style="font-size:.68rem"><?php echo e($kewenanganChartData['percentages'][2]); ?>%</div>
                        </div>
                    </div>
                <?php else: ?>
...
<div class="card-modern">
    ...
    <div class="card-body p-3">
        <div class="row g-2">
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('superadmin.index')); ?>" class="quick-action">
                    <i class="bi bi-shield-check text-primary"></i>
                    <span>Panel Verifikasi</span>
                </a>
            </div>
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('superadmin.pending-users')); ?>" class="quick-action">
                    <i class="bi bi-person-check text-warning"></i>
                    <span>Persetujuan Akun</span>
                </a>
            </div>
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('superadmin.rptka.index')); ?>" class="quick-action">
                    <i class="bi bi-file-earmark-person" style="color:#4338ca"></i>
                    <span>Verval RPTKA</span>
                </a>
            </div>
            <div class="col-6 col-md-3">
                <a href="<?php echo e(route('kewenangan-kabkota.index')); ?>" class="quick-action">
