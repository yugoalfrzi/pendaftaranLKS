<?php $__env->startSection('title', 'Dashboard LKS'); ?>
            ...
            <div class="stat-card p-3 bg-primary text-white" style="background: linear-gradient(135deg, #2563eb, #1d4ed8) !important;">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="stat-value text-white"><?php echo e(number_format($totalLKS)); ?></div>
                    </div>
            ...
            <div class="stat-card p-3 bg-success text-white" style="background: linear-gradient(135deg, #16a34a, #15803d) !important;">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="stat-value text-white"><?php echo e(number_format($lengkapLKS)); ?></div>
                    </div>
            ...
            <div class="stat-card p-3 bg-warning text-white" style="background: linear-gradient(135deg, #eab308, #ca8a04) !important;">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="stat-value text-white"><?php echo e(number_format($menungguLKS)); ?></div>
                    </div>
            ...
            <div class="stat-card p-3 bg-info text-white" style="background: linear-gradient(135deg, #0891b2, #0e7490) !important;">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="stat-value text-white"><?php echo e(number_format($diterimaLKS)); ?></div>
                    </div>
        ...
        <div class="col-md-5">
            <div class="card-modern">
                ...
                <div class="card-body p-4">
                    <?php if($kewenanganChartData['total'] > 0): ?>
                        <div class="chart-container">
                            <canvas id="kewenanganChart"></canvas>
                        </div>
                        <div class="row mt-3 text-center">
                            <div class="col-4">
                                <div class="fw-bold text-primary"><?php echo e(number_format($kewenanganKabkota)); ?></div>
                                <small class="text-muted">Kab/Kota</small>
                                <br><small class="text-muted"><?php echo e($kewenanganChartData['percentages'][0]); ?>%</small>
                            </div>
                            <div class="col-4">
                                <div class="fw-bold text-success"><?php echo e(number_format($kewenanganProvinsi)); ?></div>
                                <small class="text-muted">Provinsi</small>
                                <br><small class="text-muted"><?php echo e($kewenanganChartData['percentages'][1]); ?>%</small>
                            </div>
                            <div class="col-4">
                                <div class="fw-bold text-info"><?php echo e(number_format($kewenanganKemensos)); ?></div>
                                <small class="text-muted">Kemensos</small>
                                <br><small class="text-muted"><?php echo e($kewenanganChartData['percentages'][2]); ?>%</small>
                            </div>
                        </div>
                    <?php else: ?>
        ...
        <div class="col-md-7">
            <div class="card-modern">
                <div class="card-header-custom d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <small class="text-muted">Total: <?php echo e(number_format($totalLKSJabar)); ?> LKS</small>
                </div>
                <div class="card-body p-4">
                    <?php if($totalLKSJabar > 0): ?>
                        <div class="chart-container">
        ...
        <div class="col-12">
            <div class="card-modern">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <a href="<?php echo e(route('kewenangan-kabkota.index')); ?>" class="btn btn-outline-primary w-100 py-3 d-flex align-items-center justify-content-center gap-2 rounded-pill">
                                <i class="bi bi-building fs-5"></i>
                                <span>Kabupaten/Kota <span class="badge bg-primary ms-1"><?php echo e(number_format($kewenanganKabkota)); ?></span></span>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="<?php echo e(route('kewenangan-provinsi.index')); ?>" class="btn btn-outline-success w-100 py-3 d-flex align-items-center justify-content-center gap-2 rounded-pill">
                                <i class="bi bi-building-fill fs-5"></i>
                                <span>Provinsi <span class="badge bg-success ms-1"><?php echo e(number_format($kewenanganProvinsi)); ?></span></span>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="<?php echo e(route('kewenangan-kemensos.index')); ?>" class="btn btn-outline-info w-100 py-3 d-flex align-items-center justify-content-center gap-2 rounded-pill">
                                <i class="bi bi-house-gear fs-5"></i>
                                <span>Kemensos <span class="badge bg-info ms-1"><?php echo e(number_format($kewenanganKemensos)); ?></span></span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="card-modern">
                <div class="card-header-custom d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <a href="<?php echo e(route('lks.index')); ?>" class="btn-outline-soft btn-sm">Lihat Semua <i class="bi bi-arrow-right-short"></i></a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-modern">
                            <thead>
                                <tr><th>No</th><th>Nama LKS</th><th>Kabupaten/Kota</th><th>Tanggal Masuk</th><th>Status</th><th>Kelengkapan</th><?php if(auth()->user()->role === 'admin'): ?><th>Aksi</th><?php endif; ?></tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $recentLKS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($lks->nama_lks); ?></td>
                                    <td><span class="badge bg-light text-dark"><?php echo e($lks->kabupaten_kota ?: $lks->lokasi_lks); ?></span></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($lks->created_at)->format('d/m/Y')); ?></td>
                                    <td>
                                        <span class="badge-status <?php echo e($lks->status_permohonan == 'Diterima' ? 'badge-diterima' : ($lks->status_permohonan == 'Menunggu' ? 'badge-menunggu' : 'badge-ditolak')); ?>">
                                            <?php echo e($lks->status_permohonan ?? 'Menunggu'); ?>

                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge-status <?php echo e($lks->pendaftaran_lengkap ? 'badge-diterima' : 'badge-menunggu'); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('lks.show', $lks->id)); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
    ...
    <div class="modal fade" id="statusModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow">
                ...
                ?>
                <div class="modal-header <?php echo e($headerClass); ?> text-white border-0">
                    <h5 class="modal-title"><i class="bi <?php echo e($icon); ?> me-2"></i> Status: <?php echo e($status); ?></h5>
                ...
                <div class="modal-body">
                    ...
                    <?php elseif($isRejected): ?>
                        ...
                        <div class="mb-2"><strong>Alasan penolakan:</strong><div class="border rounded p-2 bg-light mt-1"><?php echo e($latestLks->alasan_penolakan ?? 'Tidak ada alasan.'); ?></div></div>
                    <?php elseif($isReturned): ?>
                        <div class="alert alert-warning">Permohonan Anda dikembalikan untuk perbaikan.</div>
                        <div class="mb-2"><strong>Alasan pengembalian:</strong><div class="border rounded p-2 bg-light mt-1"><?php echo e($latestLks->alasan_dikembalikan ?? 'Tidak ada alasan.'); ?></div></div>
                    <?php endif; ?>
                    <small class="text-muted">Terakhir diperbarui: <?php echo e(optional($latestLks->updated_at)->format('d/m/Y H:i')); ?></small>
                </div>
                <div class="modal-footer border-0">
                    <a href="<?php echo e(route('lks.show', $latestLks->id)); ?>" class="btn btn-outline-primary rounded-pill px-4">Lihat Detail</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(kewenanganCtx, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($kewenanganChartData['labels'], 15, 512) ?>,
                datasets: [{
                    data: <?php echo json_encode($kewenanganChartData['data'], 15, 512) ?>,
                    backgroundColor: <?php echo json_encode($kewenanganChartData['colors'], 15, 512) ?>,
                    borderColor: '#fff',
                    borderWidth: 3,
                    hoverOffset: 15
                }]
        ...
        // Chart Kabupaten (Bar)
        <?php if($totalLKSJabar > 0): ?>
        const kabupatenData = <?php echo json_encode($kabupatenData, 15, 512) ?>;
        ...
        // Trend Bulanan
        const monthlyTrend = <?php echo json_encode($monthlyTrend, 15, 512) ?>;
