<?php $__env->startSection('title', 'Detail LKS - <?php echo e($lks->nama_lks); ?>'); ?>
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    <div>
        <h1 class="h4 fw-semibold mb-1"><?php echo e($lks->nama_lks); ?></h1>
        <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            <span class="badge-pill <?php echo e($lks->kewenangan_type === 'kabkota' ? 's-proses' : 's-terverifikasi'); ?>">
                <?php echo e($lks->kewenangan_type === 'kabkota' ? 'Kewenangan Kab/Kota' : 'Kewenangan Provinsi'); ?>

            </span>
            <span class="text-muted small"><i class="bi bi-clock-history me-1"></i>Diperbarui <?php echo e($lks->updated_at->format('d/m/Y H:i')); ?></span>
        </div>
    </div>
    <div class="d-flex gap-2 flex-wrap">
        <?php if(auth()->user()->role === 'admin'): ?>
            <a href="<?php echo e(route('admin.verification', $lks->id)); ?>" class="btn btn-primary btn-sm rounded-pill px-3">
                <i class="bi bi-clipboard-check me-1"></i> Verifikasi
            </a>
        <?php endif; ?>
        <?php if(auth()->user()->hasRole(['user','admin'])): ?>
            <a href="<?php echo e(route('lks.edit', $lks->id)); ?>" class="btn btn-outline-warning btn-sm rounded-pill px-3">
                <i class="bi bi-pencil me-1"></i> Edit
            </a>
        <?php endif; ?>
        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
...
<div class="alasan-box danger mb-4">
    <i class="bi bi-x-circle me-2"></i><strong>Alasan Penolakan:</strong> <?php echo e($lks->alasan_penolakan); ?>

</div>
<?php endif; ?>
<?php if($lks->status_permohonan === 'Dikembalikan' && $lks->alasan_dikembalikan): ?>
<div class="alasan-box mb-4">
    <i class="bi bi-arrow-counterclockwise me-2"></i><strong>Alasan Dikembalikan:</strong> <?php echo e($lks->alasan_dikembalikan); ?>
    ...
    <div class="col-md-6">
        <div class="card-modern h-100">
            ...
            <div class="card-body p-3">
                <div class="info-row"><span class="info-label">Nama LKS</span><span class="info-value fw-semibold"><?php echo e($lks->nama_lks ?? '-'); ?></span></div>
                <div class="info-row"><span class="info-label">Alamat</span><span class="info-value"><?php echo e($lks->alamat_lks ?? '-'); ?></span></div>
                <div class="info-row"><span class="info-label">Kabupaten/Kota</span><span class="info-value"><?php echo e($lks->kabupaten_kota ?? $lks->lokasi_lks ?? '-'); ?></span></div>
                <div class="info-row"><span class="info-label">Nama Ketua</span><span class="info-value"><?php echo e($lks->nama_ketua_lks ?? '-'); ?></span></div>
                <div class="info-row"><span class="info-label">Jenis Pelayanan</span><span class="info-value"><?php echo e($lks->jenis_pelayanan ?? '-'); ?></span></div>
            ...
            <div class="card-body p-3">
                <div class="info-row">
                    ...
                    <span class="info-value">
                        <span class="badge-pill <?php echo e($lks->tanda_pendaftaran === 'Baru' ? 's-baru' : 's-ulang'); ?>">
                            <?php echo e($lks->tanda_pendaftaran ?? '-'); ?>

                        </span>
                    </span>
                </div>
                <div class="info-row"><span class="info-label">Tgl Masuk Dokumen</span><span class="info-value"><?php echo e(optional($lks->tanggal_masuk_dokumen)->format('d/m/Y') ?? '-'); ?></span></div>
                <div class="info-row"><span class="info-label">Tgl Persyaratan</span><span class="info-value"><?php echo e(optional($lks->tanggal_persyaratan)->format('d/m/Y') ?? '-'); ?></span></div>
                <div class="info-row">
                    <span class="info-label">Status</span>
                    <span class="info-value"><span class="badge-pill <?php echo e($sc); ?>"><?php echo e($lks->status_permohonan); ?></span></span>
                </div>
                <?php if($lks->nama_verifikator): ?>
                <div class="info-row"><span class="info-label">Verifikator</span><span class="info-value"><?php echo e($lks->nama_verifikator); ?></span></div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="card-body p-3 d-flex flex-column gap-2">
                ...
                <?php if($lks->kewenangan_type === 'kabkota'): ?>
                    <?php if($lks->sertifikat_kabkota_path): ?>
                        <div class="sertifikat-box available">
                            ...
                            <div class="d-flex gap-1">
                                <a href="<?php echo e(route('lks.preview-sertifikat-kabkota', $lks->id)); ?>" target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-3">
                                    <i class="bi bi-eye"></i> Preview
                                </a>
                                <a href="<?php echo e(route('lks.download-sertifikat-kabkota', $lks->id)); ?>" class="btn btn-sm btn-outline-success rounded-pill px-3">
                    ...
                    <?php else: ?>
                        <div class="sertifikat-box unavailable">
                            ...
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <a href="<?php echo e(route('admin.verification', $lks->id)); ?>" class="btn btn-sm btn-primary rounded-pill px-3">
                ...
                <?php if($lks->surat_rekomendasi_path): ?>
                    <div class="sertifikat-box available">
                        ...
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route('lks.preview-surat-rekomendasi', $lks->id)); ?>" target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-3">
                                <i class="bi bi-eye"></i> Preview
                            </a>
                            <a href="<?php echo e(route('lks.download-surat-rekomendasi', $lks->id)); ?>" class="btn btn-sm btn-outline-success rounded-pill px-3">
                                <i class="bi bi-download"></i> Download
                            </a>
                        </div>
                    </div>
                ...
                <?php if($lks->sertifikat_path): ?>
                    <div class="sertifikat-box available">
                        ...
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route('lks.preview-sertifikat-provinsi', $lks->id)); ?>" target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-3">
                                <i class="bi bi-eye"></i> Preview
                            </a>
                            <a href="<?php echo e(route('lks.download-sertifikat-provinsi', $lks->id)); ?>" class="btn btn-sm btn-outline-success rounded-pill px-3">
                                <i class="bi bi-download"></i> Download
                            </a>
                        </div>
                    </div>
                ...
                <?php if(!$lks->sertifikat_kabkota_path && !$lks->surat_rekomendasi_path && !$lks->sertifikat_path): ?>
                    <div class="sertifikat-box unavailable">
                        <div class="d-flex align-items-center gap-2 text-muted">
                            <i class="bi bi-file-earmark-x fs-5"></i>
                            <div>
...
<div class="card-modern">
    <div class="card-header-custom">
        ...
        <span class="ms-auto text-muted small fw-normal"><?php echo e($lks->checklists->where('kelengkapan','Ada')->count()); ?> / <?php echo e($lks->checklists->count()); ?> dokumen tersedia</span>
    </div>
        ...
        <table class="table table-doc mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="fw-semibold"><?php echo e($checklist->document->nama_dokumen); ?></span>
                    ...
                    <td>
                        <?php if($checklist->has_files): ?>
                            ...
                            <div class="doc-file-item">
                                <a href="<?php echo e(route('lks.files.show', [$lks->id, $checklist->id, $file['index']])); ?>" target="_blank" class="text-decoration-none text-primary d-flex align-items-center gap-1">
                    ...
                    <td class="text-muted small"><?php echo e($checklist->keterangan ?? '-'); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
