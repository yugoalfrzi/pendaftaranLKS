...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    <div>
        ...
        <?php if(auth()->user()->kabupaten_kota): ?>
            <span class="badge-pill s-proses"><i class="bi bi-geo-alt me-1"></i><?php echo e(auth()->user()->kabupaten_kota); ?></span>
        <?php endif; ?>
    </div>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-2">
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#0891b2,#0e7490);">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Kab/Kota</div><div class="stat-value"><?php echo e($stats['kabkota']); ?></div></div>
    ...
    <div class="col-6 col-md-2">
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#16a34a,#15803d);">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Provinsi</div><div class="stat-value"><?php echo e($stats['provinsi']); ?></div></div>
    ...
    <div class="col-6 col-md-2">
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#16a34a,#15803d);">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Diterima</div><div class="stat-value"><?php echo e($stats['diterima'] + $stats['terverifikasi']); ?></div></div>
...
<div class="card-modern mb-4">
    ...
    <div class="card-body p-3">
        <form method="GET" action="<?php echo e(route('admin.lks.index')); ?>" class="row g-2 align-items-end">
            <div class="col-md-4">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.lks.index')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill w-100">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="card-modern">
        ...
        <ul class="nav nav-tabs-modern nav-tabs" id="lksTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="tab-kabkota" data-bs-toggle="tab" data-bs-target="#pane-kabkota" type="button" role="tab">
                    ...
                    <span class="badge-pill s-proses ms-1"><?php echo e($lksKabkota->total()); ?></span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-provinsi" data-bs-toggle="tab" data-bs-target="#pane-provinsi" type="button" role="tab">
                    ...
                    <span class="badge-pill s-terverifikasi ms-1"><?php echo e($lksProvinsi->total()); ?></span>
                </button>
            </li>
        </ul>
    </div>
    ...
    <div class="tab-content" id="lksTabContent">
        ...
        <div class="tab-pane fade show active" id="pane-kabkota" role="tabpanel">
            ...
            <div class="table-responsive">
                <table class="table table-doc mb-0">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td class="text-muted"><?php echo e($lksKabkota->firstItem() + $index); ?></td>
                            <td>
                            ...
                            <td>
                                <?php if($item->sertifikat_kabkota_path): ?>
                                    <div class="d-flex gap-1">
                                        <a href="<?php echo e(route('admin.verification.preview-sertifikat-kabkota', $item->id)); ?>" target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-2"><i class="bi bi-eye"></i></a>
                                        <a href="<?php echo e(route('admin.verification.download-sertifikat-kabkota', $item->id)); ?>" class="btn btn-sm btn-outline-success rounded-pill px-2"><i class="bi bi-download"></i></a>
                                        <form action="<?php echo e(route('admin.verification.delete-sertifikat-kabkota', $item->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus tanda pendaftaran kab/kota?')">
                            ...
                            <td class="text-muted small"><?php echo e($item->nama_verifikator ?? '-'); ?></td>
                            <td>
                                <a href="<?php echo e(route('admin.verification', $item->id)); ?>" class="btn btn-sm btn-primary rounded-pill px-3" title="Upload Tanda Pendaftaran">
            ...
            <div class="px-3 py-2"><?php echo e($lksKabkota->appends(request()->query())->links()); ?></div>
            <?php else: ?>
        ...
        <div class="tab-pane fade" id="pane-provinsi" role="tabpanel">
            ...
            <div class="table-responsive">
                <table class="table table-doc mb-0">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td class="text-muted"><?php echo e($lksProvinsi->firstItem() + $index); ?></td>
                            <td>
                                <span class="fw-semibold"><?php echo e($item->nama_lks); ?></span>
                                <br><small class="text-muted"><?php echo e($item->kabupaten_kota ?? $item->lokasi_lks); ?></small>
                            </td>
                            ...
                            <td>
                                <?php if($item->surat_rekomendasi_path): ?>
                                    <div class="d-flex gap-1">
                                        <a href="<?php echo e(route('admin.verification.preview-sertifikat', $item->id)); ?>" target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-2"><i class="bi bi-eye"></i></a>
                                        <a href="<?php echo e(route('admin.verification.download-sertifikat', $item->id)); ?>" class="btn btn-sm btn-outline-success rounded-pill px-2"><i class="bi bi-download"></i></a>
                            ...
                            <td class="text-muted small"><?php echo e($item->nama_verifikator ?? '-'); ?></td>
                            <td>
                                <a href="<?php echo e(route('admin.verification', $item->id)); ?>" class="btn btn-sm btn-primary rounded-pill px-3" title="Upload Surat Rekomendasi">
                                    <i class="bi bi-upload me-1"></i> Upload
                                </a>
                            </td>
                        </tr>
            ...
            <div class="px-3 py-2"><?php echo e($lksProvinsi->appends(request()->query())->links()); ?></div>
            <?php else: ?>
