...
<?php $__env->startSection('title', 'Data Kewenangan Provinsi'); ?>
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h3 fw-semibold mb-1">
            <i class="bi bi-building-fill me-2" style="color: #0d6efd;"></i> Data Kewenangan Provinsi
        </h2>
        <p class="text-muted small mb-0">Kelola data kewenangan LKS tingkat provinsi Jawa Barat</p>
    </div>
    <div class="d-flex gap-2 mt-2 mt-sm-0">
        <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->hasRole(['super_admin'])): ?>
                <a href="<?php echo e(route('kewenangan-provinsi.export-excel')); ?>?search=<?php echo e(request('search')); ?>" class="btn btn-success rounded-pill px-3">
...
<!-- Tab Navigasi (Kab/Kota, Provinsi, Kemensos) untuk super admin -->
<?php if(auth()->guard()->check()): ?>
    <?php if(Auth::user()->hasRole('super_admin')): ?>
        <div class="mb-4">
    <ul class="nav nav-pills nav-pills-custom" id="levelTabs">
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('kewenangan-kabkota.index')); ?>">
                <i class="bi bi-geo-alt-fill"></i> Kab/Kota
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo e(route('kewenangan-provinsi.index')); ?>">
...
<div class="card-modern mb-4">
    <div class="card-header-custom d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <form method="GET" action="<?php echo e(route('kewenangan-provinsi.index')); ?>" class="d-flex align-items-center gap-2" id="filterKabkotaForm">
            ...
            <?php if($filterKabkota): ?>
                <a href="<?php echo e(route('kewenangan-provinsi.index', request()->except('filter_kabkota'))); ?>"
...
<div class="card-modern">
    <div class="card-header-custom">
        <i class="bi bi-table me-2"></i> Data Kewenangan Provinsi
    </div>
    <div class="card-body p-4">
        ...
        <div class="filter-card p-0 mb-4 border-0 bg-transparent">
            <form method="GET" class="row g-3">
                ...
                <?php if(request('search')): ?>
                <div class="col-md-2">
                    <a href="<?php echo e(route('kewenangan-provinsi.index')); ?>" class="btn btn-outline-secondary rounded-pill w-100">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                <a href="<?php echo e(route('kewenangan-provinsi.show', $item->id)); ?>" class="btn btn-sm btn-outline-info rounded-pill me-1" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(Auth::user()->hasRole('super_admin')): ?>
                                        <a href="<?php echo e(route('kewenangan-provinsi.edit', $item->id)); ?>" class="btn btn-sm btn-outline-warning rounded-pill me-1" title="Edit">
...
function confirmDelete(id, name) {
    ...
    document.getElementById('deleteForm').action = `/kewenangan-provinsi/${id}`;
    const deleteModal = new bootstrap.Modal(document.getElementById('deleteModal'));
    deleteModal.show();
}
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pendaftaranLKS\resources\views/kewenangan/provinsi/index.blade.php ENDPATH**/ ?>