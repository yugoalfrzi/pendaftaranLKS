...
<?php $__env->startSection('page-title', 'Permohonan RPTKA'); ?>
...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    ...
    <a href="<?php echo e(route('rptka.create')); ?>" class="btn btn-primary btn-sm rounded-pill px-3">
...
<div class="card-modern mb-3">
    ...
    <div class="card-body p-3">
        <form method="GET" action="<?php echo e(route('rptka.index')); ?>" class="row g-2 align-items-end">
            <div class="col-md-5">
                <label class="form-label small fw-semibold mb-1">Pencarian</label>
                <input type="text" class="form-control form-control-sm" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama LKS atau nama TKA...">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-3 d-flex gap-2">
                ...
                <a href="<?php echo e(route('rptka.index')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill w-100">Reset</a>
            </div>
        </form>
    </div>
</div>
        ...
        <table class="table table-doc mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="fw-semibold"><?php echo e($item->nama_lks); ?></span><br>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route('rptka.show', $item->id)); ?>" class="btn btn-sm btn-outline-info rounded-pill px-2" title="Detail"><i class="bi bi-eye"></i></a>
                            <a href="<?php echo e(route('rptka.edit', $item->id)); ?>" class="btn btn-sm btn-outline-warning rounded-pill px-2" title="Edit"><i class="bi bi-pencil"></i></a>
                            <form action="<?php echo e(route('rptka.destroy', $item->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus data RPTKA ini?')">
