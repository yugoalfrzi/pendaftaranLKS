<?php $__env->startSection('title', 'Tambah Data Kewenangan Provinsi'); ?>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('kewenangan-provinsi.store')); ?>" method="POST" id="mainForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_pusat_nama_kab_kota" value="<?php echo e(old('tanda_pendaftaran_pusat_nama_kab_kota')); ?>" required placeholder="Masukkan nama kabupaten/kota pusat">
                                    <?php $__errorArgs = ['tanda_pendaftaran_pusat_nama_kab_kota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_pusat_nomor" value="<?php echo e(old('tanda_pendaftaran_pusat_nomor')); ?>" required placeholder="Masukkan nomor tanda daftar pusat">
                                    <?php $__errorArgs = ['tanda_pendaftaran_pusat_nomor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanda_pendaftaran_pusat_tanggal" value="<?php echo e(old('tanda_pendaftaran_pusat_tanggal')); ?>" required>
                                    <?php $__errorArgs = ['tanda_pendaftaran_pusat_tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_cabang_nama_kab_kota" value="<?php echo e(old('tanda_pendaftaran_cabang_nama_kab_kota')); ?>" required placeholder="Masukkan nama kabupaten/kota cabang">
                                    <?php $__errorArgs = ['tanda_pendaftaran_cabang_nama_kab_kota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_cabang_nomor" value="<?php echo e(old('tanda_pendaftaran_cabang_nomor')); ?>" required placeholder="Masukkan nomor tanda daftar cabang">
                                    <?php $__errorArgs = ['tanda_pendaftaran_cabang_nomor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanda_pendaftaran_cabang_tanggal" value="<?php echo e(old('tanda_pendaftaran_cabang_tanggal')); ?>" required>
                                    <?php $__errorArgs = ['tanda_pendaftaran_cabang_tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="rekom_dinsos_nomor" value="<?php echo e(old('rekom_dinsos_nomor')); ?>" required placeholder="Masukkan nomor rekomendasi">
                                    <?php $__errorArgs = ['rekom_dinsos_nomor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="rekom_dinsos_tanggal" value="<?php echo e(old('rekom_dinsos_tanggal')); ?>" required>
                                    <?php $__errorArgs = ['rekom_dinsos_tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tanda_pendaftaran_provinsi_nomor" value="<?php echo e(old('tanda_pendaftaran_provinsi_nomor')); ?>" required placeholder="Masukkan nomor tanda daftar provinsi">
                                    <?php $__errorArgs = ['tanda_pendaftaran_provinsi_nomor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tanda_pendaftaran_provinsi_tanggal" value="<?php echo e(old('tanda_pendaftaran_provinsi_tanggal')); ?>" required>
                                    <?php $__errorArgs = ['tanda_pendaftaran_provinsi_tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                    <a href="<?php echo e(route('kewenangan-provinsi.index')); ?>" class="btn btn-secondary btn-lg me-md-2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pendaftaranLKS\resources\views/kewenangan/provinsi/create.blade.php ENDPATH**/ ?>