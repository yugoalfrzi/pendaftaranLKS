...
<head>
    ...
    <!-- ICON PAGE -->
    <link rel="icon" href="<?php echo e(asset('assets/Apps/vendors/images/silaskar-icon.png')); ?>" type="image/jpeg">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="<?php echo e(route('dashboard')); ?>" class="logo">
                <img src="<?php echo e(asset('assets/Apps/vendors/images/silaskar.jpeg')); ?>" alt="SI LASKAR">
        ...
        <nav class="nav flex-column">
            ...
            <?php $infoActive = request()->routeIs('announcements.*'); ?>
            <button class="nav-link dd-toggle <?php echo e($infoActive ? 'dd-open active' : ''); ?>" data-target="infoSubmenu">
                <i class="bi bi-megaphone"></i><span>Pengumuman</span>
                <i class="bi bi-chevron-down dd-arrow"></i>
            </button>
            <div class="submenu <?php echo e($infoActive ? 'open' : ''); ?>" id="infoSubmenu">
            ...
            <a class="nav-link <?php echo e(request()->routeIs('lks.terdaftar') ? 'active' : ''); ?>" href="<?php echo e(route('lks.terdaftar')); ?>">
                ...
                <?php if(auth()->user()->hasRole('user')): ?>
                    ...
                    <?php $perluPerhatianCount = \App\Models\LKS::where('user_id', auth()->id())->whereIn('status_permohonan', ['Ditolak', 'Dikembalikan'])->count(); ?>
                    <?php if($perluPerhatianCount > 0): ?>
                        <span class="badge bg-danger"><?php echo e($perluPerhatianCount); ?></span>
                    <?php endif; ?>
                <?php else: ?>
            ...
            <?php $dataLksActive = request()->routeIs('kewenangan-*'); ?>
            <button class="nav-link dd-toggle <?php echo e($dataLksActive ? 'dd-open active' : ''); ?>" data-target="dataLksSubmenu">
                <i class="bi bi-database"></i><span>Data LKS JABAR</span>
                <i class="bi bi-chevron-down dd-arrow"></i>
            </button>
            <div class="submenu <?php echo e($dataLksActive ? 'open' : ''); ?>" id="dataLksSubmenu">
                <?php if(Auth::user()->hasRole('user')): ?>
                    <a class="nav-link <?php echo e(request()->routeIs('kewenangan-kabkota.create') ? 'active' : ''); ?>" href="<?php echo e(route('kewenangan-kabkota.create')); ?>">
                        <i class="bi bi-geo-alt"></i><span>Input kewenangan Kab/Kota</span>
                    </a>
                    <a class="nav-link <?php echo e(request()->routeIs('kewenangan-provinsi.create') ? 'active' : ''); ?>" href="<?php echo e(route('kewenangan-provinsi.create')); ?>">
                        <i class="bi bi-map"></i><span>Input kewenangan Provinsi</span>
                    </a>
                    <a class="nav-link <?php echo e(request()->routeIs('kewenangan-kemensos.create') ? 'active' : ''); ?>" href="<?php echo e(route('kewenangan-kemensos.create')); ?>">
            ...
            <?php if(Auth::user()->hasRole('super_admin')): ?>
                ...
                <a class="nav-link <?php echo e(request()->routeIs('hibah.*') ? 'active' : ''); ?>" href="<?php echo e(route('hibah.keuangan', ['tahun' => now()->year])); ?>">
            ...
            <?php if(Auth::user()->role === 'super_admin'): ?>
                ...
                <?php $pendingCount = \App\Models\User::where('approval_status','pending')->where('role','user')->count(); ?>
                <a class="nav-link <?php echo e(request()->routeIs('superadmin.pending-users') ? 'active' : ''); ?>" href="<?php echo e(route('superadmin.pending-users')); ?>">
                ...
                <a class="nav-link <?php echo e(request()->routeIs('lks.index') ? 'active' : ''); ?>" href="<?php echo e(route('lks.index')); ?>">
