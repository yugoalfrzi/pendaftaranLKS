...
<?php if($lksPerluPerhatian && $lksPerluPerhatian->count() > 0): ?>
<div class="card-modern mb-4" style="border-left:4px solid #f87171;">
    <div class="card-header-custom d-flex justify-content-between align-items-center">
        ...
        <span class="badge bg-danger rounded-pill" style="font-size:.72rem;"><?php echo e($lksPerluPerhatian->count()); ?> perlu tindakan</span>
    </div>
    <div class="card-body p-3 d-flex flex-column gap-2">
        <?php $__currentLoopData = $lksPerluPerhatian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="d-flex align-items-center justify-content-between p-3 rounded-3 gap-3"
             style="background:<?php echo e($bg); ?>; border:1px solid <?php echo e($bc); ?>;">
            <div class="d-flex align-items-center gap-3 flex-1 min-w-0">
                <i class="bi <?php echo e($ico); ?> fs-5 flex-0 badge-pill <?php echo e($cls); ?>" style="padding:.4rem; border-radius:.6rem;"></i>
                <div class="min-w-0">
                    <div class="fw-semibold text-truncate" style="font-size:.85rem;"><?php echo e($lks->nama_lks); ?></div>
                    <div class="text-muted" style="font-size:.75rem;">
                        <?php echo e($lks->updated_at->diffForHumans()); ?>

                        <?php if($isDitolak && $lks->alasan_penolakan): ?>
                            &mdash; <span class="text-danger"><?php echo e(Str::limit($lks->alasan_penolakan, 70)); ?></span>
                        <?php elseif(!$isDitolak && $lks->alasan_dikembalikan): ?>
                            &mdash; <span style="color:#b45309;"><?php echo e(Str::limit($lks->alasan_dikembalikan, 70)); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="d-flex align-items-center gap-2 flex-0">
                <span class="badge-pill <?php echo e($cls); ?>"><?php echo e($lks->status_permohonan); ?></span>
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#2563eb,#1d4ed8);">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Total LKS Terdaftar</div><div class="stat-value"><?php echo e($stats['kabkota'] + $stats['provinsi']); ?></div></div>
    ...
    <div class="col-md-4">
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#0891b2,#0e7490);">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Kewenangan Kab/Kota</div><div class="stat-value"><?php echo e($stats['kabkota']); ?></div></div>
    ...
    <div class="col-md-4">
        <div class="stat-card p-3" style="background:linear-gradient(135deg,#16a34a,#15803d);">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="stat-label">Kewenangan Provinsi</div><div class="stat-value"><?php echo e($stats['provinsi']); ?></div></div>
    ...
    <div class="card-body p-3">
        <form method="GET" action="<?php echo e(route('lks.terdaftar')); ?>">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="<?php echo e(route('lks.terdaftar')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill w-100">
                ...
                <table class="table table-doc mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge-pill <?php echo e($item->tanda_pendaftaran == 'Baru' ? 's-baru' : 's-ulang'); ?>">
                            ...
                            <td>
                                <div class="d-flex gap-1 flex-wrap">
                                    <a href="<?php echo e(route('lks.preview-sertifikat-kabkota', $item->id)); ?>"
                                       target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-2" title="Preview">
                                        <i class="bi bi-eye"></i> Preview
                                    </a>
                                    <a href="<?php echo e(route('lks.download-sertifikat-kabkota', $item->id)); ?>"
                            ...
                            <td>
                                <a href="<?php echo e(route('lks.show', $item->id)); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-2" title="Lihat Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
                ...
                <table class="table table-doc mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1 flex-wrap">
                                    <a href="<?php echo e(route('lks.preview-sertifikat-provinsi', $item->id)); ?>"
                                       target="_blank" class="btn btn-sm btn-outline-info rounded-pill px-2" title="Preview">
                                        <i class="bi bi-eye"></i> Preview
                                    </a>
                                    <a href="<?php echo e(route('lks.download-sertifikat-provinsi', $item->id)); ?>"
                                       class="btn btn-sm btn-outline-success rounded-pill px-2" title="Download">
                                        <i class="bi bi-download"></i> Download
                                    </a>
                                </div>
