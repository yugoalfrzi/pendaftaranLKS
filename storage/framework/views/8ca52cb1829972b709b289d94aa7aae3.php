...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="stat-card p-3">
            ...
            <div class="stat-value"><?php echo e($stats['kabkota'] + $stats['provinsi']); ?></div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card p-3">
            ...
            <div class="stat-value" style="color:#1d4ed8;"><?php echo e($stats['kabkota']); ?></div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="stat-card p-3">
            ...
            <div class="stat-value" style="color:#15803d;"><?php echo e($stats['provinsi']); ?></div>
        </div>
    </div>
</div>
