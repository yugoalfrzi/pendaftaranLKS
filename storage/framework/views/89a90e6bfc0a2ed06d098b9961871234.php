        ...
        <div class="register-card">
            <div class="register-form-container">
                ...
                <div class="alert-custom mb-3" style="background:#fff8e1;color:#856404;border-left:4px solid #ffc107;border-radius:1rem;padding:0.75rem 1rem;font-size:0.85rem;">
                    <i class="bi bi-clock-history me-2"></i><?php echo e(session('pending')); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                   value="<?php echo e(old('name')); ?>" placeholder="Nama LKS Anda" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                   value="<?php echo e(old('email')); ?>" placeholder="nama@contoh.com" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" id="kabupaten_kota" name="kabupaten_kota" required
                                ...
                                <option value="" disabled <?php echo e(old('kabupaten_kota') ? '' : 'selected'); ?>>-- Pilih Kabupaten/Kota --</option>
                                <?php
                                $kabupatenKota = [
                                ...
                                ?>
                                <?php $__currentLoopData = $kabupatenKota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kk); ?>" <?php echo e(old('kabupaten_kota') === $kk ? 'selected' : ''); ?>>
                                        <?php echo e($kk); ?>
                ...
                <!-- Google Register -->
                <a href="<?php echo e(route('auth.google')); ?>" class="btn w-100 d-flex align-items-center justify-content-center gap-2"
...
<?php /**PATH C:\xampp\htdocs\pendaftaranLKS\resources\views/register.blade.php ENDPATH**/ ?>